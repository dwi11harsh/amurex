...
interface ChatSidebarProps {
  ...
  handleChatSubmit: (e: FormEvent) => Promise<void>;
}

export const MeetChatSidebar = ({
  isOpen,
  chatMessages,
  chatInput,
  isSending,
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 font-poppins">
          <div className="flex justify-start">
            <div className="max-w-[80%] rounded-3xl text-md text-white">
              Hey, I&apos;m ready to help you with any questions you have about
              this meeting. What can I do for you?
            </div>
          </div>
